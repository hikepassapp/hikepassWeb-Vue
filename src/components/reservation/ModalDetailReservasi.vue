      ...
      <div v-if="reservation" class="detail-content">
        <div class="detail-info">
          <div class="info-item">
            ...
            <span>{{ reservation.mountain?.name || '-' }}</span>
          </div>
          ...
          <div class="info-item">
            <strong>NIK:</strong>
            <span>{{ reservation.nik }}</span>
          </div>
          
          <div class="info-item">
            <strong>Jenis Kelamin:</strong>
            <span>{{ formatGender(reservation.gender) }}</span>
          </div>
        ...
        <div class="modal-actions">
          ...
          <button type="button" class="btn-checkin" @click="openCheckinModal">
            Check-in
          </button>
        </div>
      </div>
